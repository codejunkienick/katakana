    ...
    return (
      <div className={styles.blog}>
        ...
        <BlogEntry
          ...
          <p>
            Вот уже почти как год я и <Link to="/contact#igorlem" title="@igorlem">Игорь</Link> зарегистрировали katakana.me, с тех пор мы несколько раз начинали разработку. Нарисовали скетчей, наделали прототипов, заводили репозиторий на bitbucket, но потом отвлекались на разработку приложений на iOS и Android, освоение новых фреймворков и языков. Игорь в свою очередь занялся типографией и уже почти завершил свой собственный <a href="https://www.behance.net/gallery/37329789/Vocal-Typeface">шрифт</a>.
          </p>

    ...
    return (
      <div className={styles.blog}>
        ...
        <BlogEntry
          ...
          <p>
            Вот уже почти как год я и Игорь Лемешкин зарегистрировали katakana.me, с тех пор мы несколько раз начинали разработку. Нарисовали скетчей, наделали прототипов, заводили репозиторий на bitbucket, но потом отвлекались на разработку приложений на iOS и Android, освоение новых фреймворков и языков. Игорь в свою очередь занялся типографией и уже почти завершил свой собственный <a href="https://www.behance.net/gallery/37329789/Vocal-Typeface">шрифт</a>.
          </p>

          <p>
            После всего этого времени я решил, что нужно положить конец повисшему состоянию катаканы и создать что-то исключительно для себя, собственное место в сети. Не долго думая, я попросил Игоря отправить его старые скетчи и начал с ними работать. Затем решил сменить адрес на katakana.xyz, слишком уж сильно кусался ценник за поддержку .me домена.
          </p>
          <p>
          ...
          <p>
            Так для чего же все-таки эта катакана? Я начинал создавать проект, держа в голове изображения портфолио выложенного плиткой, лендинга с анимациями и кнопками нанять, посчитать проект. Спустя год я понял, что мне это все не нужно, что мне хватит лишь сайта, где я бы мог делиться информацией о своих проектах, делиться своими идеями и решениями проблем, которые мне пришлось преодолеть, делая какой-либо проект.
